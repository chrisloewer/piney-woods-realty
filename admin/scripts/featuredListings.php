<?php
	...
	echo "<h1 class='centerText'>FEATURED LISTINGS</h1><br/><br/>";
	
	echo "<!-- Listings in 2 columns --> <br/>";
	echo "<div class='grid' id='featuredListing_grid'>";
	echo "	<div class='col-1-2'>";
	echo "		<div class='imagePlaceholder' style='background-image: url(\"images/listings/" . $listing1 . "/0.jpg\")'></div>";
	echo "		<h2 class='centerText'>$listing1Title</h2>";
	echo "		<p class='centerText'>$listing1Description</p>";
	echo "	</div>";
	echo "	<div class='col-1-2-r'>";
	echo "		<div class='imagePlaceholder' style='background-image: url(\"images/listings/" . $listing2 . "/0.jpg\")'></div>";
	echo "		<h2 class='centerText'>$listing2Title</h2>";
